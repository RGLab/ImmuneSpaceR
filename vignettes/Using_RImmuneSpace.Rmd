...
The *sdy269* object is an **R6** class, so it behaves like a true object. 
...
## <a id="plot"></a>Plotting
A plot of a dataset can be generated using the `plot` method.

`plot` automatically chooses the type of plot depending on the selected 
dataset.
...
Likewise, `plot` will visualize accross studies. Note that in most cases the
