...
hai <- hai[,response:=value_reported/value_reported[study_time_collected==0],
                 by="virus_strain,cohort,participant_id"][study_time_collected==30]
hai <- hai[, list(participant_id, virus_strain, response)]
...
vn <- vn[, response:=value_reported/value_reported[study_time_collected==0],
                 by="virus_strain,cohort,participant_id"][study_time_collected==30]
vn <- vn[, list(participant_id, virus_strain, response)]
