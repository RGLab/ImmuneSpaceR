...
TIV_2011 <- all$getGEMatrix(matrixName = "TIV_2011")
```
...
```{r summary}
TIV_2008_sum <- sdy269$getGEMatrix("TIV_2008", summary = TRUE, currAnno = TRUE)
```
...
TIV_seasons <- all$getGEMatrix(c("TIV_2008", "TIV_2011"), summary = TRUE, currAnno = TRUE)
```
