.onLoad <- function(libname, pkgname){
  ...
  if(!file.exists(def_netrc)){
    message("A .netrc file is required to connect to ImmuneSpace. For more
            information on how to create one, refer to the Configuration section
            of the introduction vignette.")
  }
