...
.ISCon$methods(
  GeneExpressionFeatures = function(matrixName,
    ...
    getOrigFasId <- function(config, matrixName) {
      ...
      # '_orig' annotation is the feature annotation copy generated by updateAnno when run
      # on the server.  In the case of SDY67, the copy is not generated because it is has
      # 'ImmSig'.  Therefore, no change to the fasNm is needed. 
