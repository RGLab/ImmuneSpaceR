...
2. [Instantiate a connection](#Configuration)
...
As the schema stabilizes, we plan to implement automated merging of different data types within, and eventually across assays (using different connections for example). 
